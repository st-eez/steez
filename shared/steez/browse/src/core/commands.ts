...
export const COMMAND_DESCRIPTIONS: Record<string, { category: string; description: string; usage?: string }> = {
  ...
  'ns set':      { category: 'NetSuite', description: 'Set field value with auto-detect cascading', usage: 'ns set <field|@ref> <value> [--source|--fire-field-changed|--no-source]' },
  ...
  'ns diff':     { category: 'NetSuite', description: 'Snapshot all fields, optionally perform an action, then show what changed', usage: 'ns diff [set <field|@ref> <value> [--source|--fire-field-changed|--no-source]]' },
  ...
  'ns script-log': { category: 'NetSuite', description: 'Fetch SuiteScript execution log entries by scraping the script record page', usage: 'ns script-log <scriptid> [--level DEBUG|AUDIT|ERROR|EMERGENCY|SYSTEM] [--limit N]' },
  // Playwright
